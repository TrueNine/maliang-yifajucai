...
select
    add_base_struct('black_list_tag');
...
select
    add_base_struct('black_list_black_list_tag');
...
select
    add_base_struct('black_list_relation');
...
select
    add_base_struct('black_list_evidence');
