...
export class UserInfoV2Api {
  ...
  readonly getCitizenVerified: () => Promise<
    boolean
  > = async () => {
    const _uri = '/v2/user_info/me/citizen_verified'
  ...
  > = async () => {
    const _uri = '/v2/user_info/me/dis_info'
  ...
  > = async () => {
    const _uri = '/v2/user_info/me/form'
...
export interface UserInfoV2ApiOptions {
  getDisInfoAsMe: {}
