...
export class CommonApi {
  ...
  readonly getAllChinaMinorities: () => Promise<
    Array<string>
  > = async () => {
    const _uri = '/v2/common/china_minorities'
  ...
  readonly getBusinessOrderCode: () => Promise<
    string
  > = async () => {
    const _uri = '/v2/common/business_order_code'
    return (await this.executor({ uri: _uri, method: 'GET' })) as Promise<string>
  }
  ...
  readonly getServerSnowflakeId: () => Promise<
    string
  > = async () => {
    const _uri = '/v2/common/server_snowflake_id'
    return (await this.executor({ uri: _uri, method: 'GET' })) as Promise<string>
  }
  ...
  readonly getServerThrowable: () => Promise<
    void
  > = async () => {
    const _uri = '/v2/common/server_throwable'
  ...
  readonly getUuid: () => Promise<
    string
  > = async () => {
    const _uri = '/v2/common/java_uuid'
    return (await this.executor({ uri: _uri, method: 'GET' })) as Promise<string>
  }
