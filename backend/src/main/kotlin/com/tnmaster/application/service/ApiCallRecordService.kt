...
import com.tnmaster.application.repositories.IApiCallRecordRepo
...
class ApiCallRecordService(private val jimmerApiCallRecordRepo: IApiCallRecordRepo, private val redisTemplate: RedisTemplate<String, ApiCallRecord?>) {
  companion object {
    private val log = slf4j<ApiCallRecordService>()
  ...
  fun scheduledCacheSaveToDatabase() {
    ...
    if (null != cacheData) {
      jimmerApiCallRecordRepo.sql.insertEntities(cacheData)
      clearCachedRecords()
    }
  }
