alter table
    ...
    add column if not exists leader_name    varchar(255)  default null,
    add column if not exists reg_capital    decimal(10,
                                                2)        default null,
...
select add_base_struct('enterprise_phone');
...
select add_base_struct('enterprise_email');
