...
select
    add_base_struct('contents');

select
    add_tree_struct('contents');
...
select
    add_base_struct('contents_attachment');
...
select
    add_base_struct('content_comments_votes');
...
select
    add_base_struct('contents_contents_tags');
